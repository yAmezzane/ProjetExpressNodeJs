...
app.get('/AnassMap', (req, res) => {
    ...
    app.post('/monuments/save', (req, res) => {
        ...
        var tof = photo.data;
        if (photo.mimetype == "image/jpg" || photo.mimetype == "image/png" || photo.mimetype == "image/gif") {

            photo.mv('views/monuments/images/' + photo.name)
        }

        let data = { id: req.body.id, nom: req.body.nom, latitude: req.body.latitude, longitude: req.body.longitude, ville: req.body.ville, img: photo.name};
